...
import { type LoadLastEventRepository } from '@/app/repositories/load-last-event-repository';
import { CheckLastEventStatus } from '@/app/use-cases/check-last-event-status';
